...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <h2 style="text-align: center; color: #ff6600" ><b>Globalindo Intimates - Cutting Report by Date Range</b></h2>
  ...
  $('#filter').click(function(){
    ...
    if(from_date != '' && to_date != '')  
    {
      if(tgl1 > tgl2){
        ...
        $.ajax({  
              url:"<?php echo site_url('report_cutting/ReportCuttingByOrc/filter');?>",  
              method:"POST",  
