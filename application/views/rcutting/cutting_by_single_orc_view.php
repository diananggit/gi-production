  ...
  <script type="text/javascript">
    ...
    // $(document).ready(function() {
      ...
      function load_orc() {
        $('#orc').empty();
        $.ajax({
          url: "<?php echo site_url('report_cutting/ReportCuttingSingleOrc/ajax_get_all_orc'); ?>",
          type: 'get',
          dataType: 'json',
          }).done(function(data){
       ...
       $('#orc').change(function() {
        ...
        $.when(
          ...
          $.ajax({
            url: '<?php echo site_url("report_cutting/ReportCuttingSingleOrc/ajax_get_by_orc3"); ?>/' + orc,
            type: 'GET',
            dataType: 'json',
          }).done(function(data) {
        ...
        $.ajax({
          url: '<?php echo site_url("report_cutting/ReportCuttingSingleOrc/ajax_get_by_orc"); ?>/' + orc,
          type: 'GET',
          dataType: 'json',
        ...
        $.ajax({
          url: '<?php echo site_url("report_cutting/ReportCuttingSingleOrc/ajax_get_by_orc2"); ?>/' + orc,
          type: 'GET',
          dataType: 'json',
        }).done(function(data) {
