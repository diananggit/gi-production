...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <h2 style="text-align: center; color: #ffc107" ><b>Globalindo Intimates - Cutting Report</b></h2>
...
function formatDate(date) {
  ...
  function showReportCutting() {
    $.ajax({
      url: '<?php echo site_url('report_cutting/ReportBarChartCutting/ajax_get_qty_cutting') ; ?>',
      type: 'GET',
      dataType: 'json',
      }).done(function(data){
        console.log(data);
