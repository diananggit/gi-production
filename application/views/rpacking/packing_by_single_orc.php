  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          <h2 style="text-align: center; color: #007bff">Globalindo Intimates - Packing Report by Single ORC</h2>
          ...
          <div class="card-body mt-1">
            ...
            <div class="card card-primary" style="height:50%; width:60%" height:"50%" width:"60%">
              ...
              <div class="card-body">
            <!-- <div class="row"> -->
                <table id="tableOrcPacking" class="table table-border table-striped" width="100%">
                  <thead>
                    <tr>
                      <th>DAY</th>
                      <th>DATE</th>
