...
<script src="<?php echo base_url('plugins/chart.js/chartjs-plugin-datalabels.min.js'); ?>"></script>
<!-- <script src="<?php echo base_url('plugins/chart.js/charts2.0.js'); ?>"></script>s -->
