            ...
            <form method="post" id="form">
                <div class="modal-body">
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Barcode</label>
                            <div class="col-md-10">
                                <input type="text" id="barcode_input_molding" class="form-control">
                            </div>
                        </div>
                </div>
                <div class="modal-footer">
...
<!-- report cutting-->
<!-- <div class="modal fade" id="modalReportCutting" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Show Bundle</h4>
            ...
            <form method="post" id="form">
                <div class="modal-body">
                    <div class="row">
                        <table id="showCuttingByStyle class="table table-border table-striped" width="100%" >
                            <thead>
                                <th>#</th>  
                                <th>TANGGAL</th>
                                <th>STYLE</th>
