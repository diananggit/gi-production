...
class ReportPackingByOrcModel extends CI_Model{
    var $table="v_orc_packing";
    var $column_order = array('tgl','orc','order','qty_packing','balance');
