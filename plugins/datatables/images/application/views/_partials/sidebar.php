        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="fa fa-arrow-circle-right text-info nav-icon"></i>
                  <p>Master Size</p>
                </a>
              </li>
              <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="fa fa-arrow-circle-right text-warning nav-icon"></i>
                  <p>Print Label & Barcode, Initialize Line Sewing Also</p>
                </a>
              </li>              
            </ul>
          </li>
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              <i class="nav-icon fa fa-pin text-warning"></i>
              <p>
                Sewing Process
                <i class="fa fa-angle-left right"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="fa fa-arrow-circle-right text-warning nav-icon"></i>
                  <p>Print Label & Barcode Also Initialize Line Sewing</p>
                </a>
              </li>              
            </ul>
          </li>
